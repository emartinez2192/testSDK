#
#  Be sure to run `pod spec lint TestCocoFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "TestCocoFramework"
  s.version      = "0.0.1"
  s.summary      = "A short description of TestCocoFramework."
  ...
  s.author             = { "eduardo" => "emartinez@na-at.com.mx" }
  # Or just: s.author    = "eduardo"
  # s.authors            = { "eduardo" => "emartinez@na-at.com.mx" }
  # s.social_media_url   = "http://twitter.com/eduardo"
